        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <p class="text-muted" style="line-height: 1.8;">
                    From a hearty breakfast to a satisfying dinner, our restaurant provides a welcoming setting to enjoy
                    quality food with family, friends, or colleagues.
                </p>
                <div class="row g-3 my-3">
                    <div class="col-md-6">
                        <div class="p-3 rounded-3 bg-light border-start border-3 border-warning h-100">
                            <h6 class="font-serif mb-1 text-dark">Breakfast Buffet</h6>
                            <span class="small text-primary fw-semibold d-block mb-1">7:00 AM – 10:30 AM Daily</span>
                            <p class="small text-muted mb-0" style="line-height: 1.5;">Start your day with a wholesome
                                selection of freshly prepared breakfast favourites and South Indian specialities.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="p-3 rounded-3 bg-light border-start border-3 border-warning h-100">
                            <h6 class="font-serif mb-1 text-dark">Lunch & Dinner</h6>
                            <span class="small text-primary fw-semibold d-block mb-1">12:30 PM – 10:30 PM Daily</span>
                            <p class="small text-muted mb-0" style="line-height: 1.5;">Enjoy a variety of vegetarian,
                                non-vegetarian, Chinese, South Indian, and North Indian dishes prepared fresh for every
                                meal.</p>
                        </div>
                    </div>
                </div>
                <a href="#menuTabs" class="btn btn-luxury mt-2">EXPLORE OUR MENU</a>
            </div>
...
<section class="py-5" style="background-color: var(--bg-cream);">
    <div class="container py-lg-4">
        <div class="text-center mb-5" data-aos="fade-up">
            ...
            <p class="section-subtitle">Categorized a la carte selections crafted with the finest organic and artisanal
                ingredients.</p>
        </div>
        ...
        <ul class="nav nav-pills justify-content-center mb-5 gap-2" id="menuTabs" role="tablist" data-aos="fade-up">
            <li class="nav-item" role="presentation">
                <button class="nav-link active rounded-pill px-4 py-2 fw-semibold" id="all-tab" data-bs-toggle="pill"
                    data-bs-target="#tab-all" type="button" role="tab">All Selections</button>
            </li>
            <?php if (!empty($categories)):
                foreach ($categories as $idx => $cat): ?>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link rounded-pill px-4 py-2 fw-semibold" id="tab-btn-<?php echo $cat['id']; ?>"
                            data-bs-toggle="pill" data-bs-target="#tab-<?php echo $cat['id']; ?>" type="button" role="tab">
                            ...
                            <div class="col-lg-6" data-aos="fade-up">
                                <div class="card border-0 rounded-3 p-3 shadow-sm h-100" style="background: #ffffff;">
                                    <div class="d-flex gap-3 align-items-center">
                                        <img src="<?php echo htmlspecialchars($item['image'] ?: 'https://images.unsplash.com/photo-1533777857889-4be7c70b33f7?auto=format&fit=crop&w=600&q=80'); ?>"
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="mb-2">
                                                <?php if ($item['dietary_type'] == 'veg'): ?>
                                                    <span
                                                        class="badge bg-success-subtle text-success border border-success-subtle py-1 px-2 small"><i
                                                            class="fa-solid fa-leaf me-1"></i> Vegetarian</span>
                                                <?php else: ?>
                                                    <span
                                                        class="badge bg-danger-subtle text-danger border border-danger-subtle py-1 px-2 small"><i
                                                            class="fa-solid fa-drumstick-bite me-1"></i> Non-Veg</span>
                                                <?php endif; ?>
                                                <?php if (!empty($item['badge'])): ?>
                                                    <span
                                                        class="badge bg-warning-subtle text-warning-emphasis border border-warning-subtle py-1 px-2 small"><?php echo htmlspecialchars($item['badge']); ?></span>
                                                <?php endif; ?>
                                            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8" data-aos="fade-up">
                <div class="card border-0 shadow-lg rounded-4 p-4 p-md-5"
                    style="background: #ffffff; border: 1px solid rgba(197, 168, 128, 0.3);">
                    <div class="text-center mb-4">
                        <span class="section-badge">TABLE RESERVATIONS</span>
                        <h2 class="font-serif">Reserve A Table at The Sapphire</h2>
                        <p class="text-muted small">Special anniversary dinners, private seaside cabanas, and wine
                            pairing tastings.</p>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="search-field-label"><i class="fa-solid fa-user text-primary"></i> Guest
                                    Name *</label>
                                <input type="text" name="guest_name" class="search-field-input"
                                    placeholder="Your Full Name" required>
                            </div>
                            <div class="col-md-6">
                                <label class="search-field-label"><i class="fa-solid fa-envelope text-primary"></i>
                                    Email Address *</label>
                                <input type="email" name="email" class="search-field-input" placeholder="Your Email"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label class="search-field-label"><i class="fa-solid fa-phone text-primary"></i> Phone
                                    Number *</label>
                                <input type="tel" name="phone" class="search-field-input" placeholder="+91 98765 43210"
                                    required>
                            </div>
                            <div class="col-md-3">
                                <label class="search-field-label"><i class="fa-solid fa-calendar text-primary"></i> Date
                                    *</label>
                                <input type="date" name="reservation_date" class="search-field-input" required
                                    min="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                            <div class="col-md-3">
                                <label class="search-field-label"><i class="fa-solid fa-clock text-primary"></i> Time
                                    *</label>
                                <input type="time" name="reservation_time" class="search-field-input" required
                                    value="19:30">
                            </div>
                            <div class="col-md-6">
                                <label class="search-field-label"><i class="fa-solid fa-user-group text-primary"></i>
                            ...
                            <div class="col-md-6">
                                <label class="search-field-label"><i class="fa-solid fa-chair text-primary"></i> Seating
                                    Preference</label>
                            ...
                            <div class="col-12">
                                <label class="search-field-label"><i
                                        class="fa-solid fa-champagne-glasses text-primary"></i> Special Requests &
                                    Dietary Notes</label>
                                <textarea name="special_notes" class="search-field-input" rows="3"
                                    placeholder="Anniversary flower setup, vegan requirement, cake cutting, etc."></textarea>
                            </div>
                        </div>
