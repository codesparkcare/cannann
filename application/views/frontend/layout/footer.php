        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                ...
                <p class="text-white-50 mb-4" style="line-height: 1.8; font-size: 0.92rem;">
                    <?php echo htmlspecialchars($settings['hotel_tagline'] ?? 'Where Timeless Heritage Meets Contemporary Luxury.'); ?>
                    Designed to offer discerning travelers an unforgettable escape of coastal calm, Michelin dining, and
                    regal hospitality.
                </p>
                <div class="d-flex gap-2">
                    <?php if (!empty($settings['facebook_url'])): ?>
                        <a href="<?php echo $settings['facebook_url']; ?>" target="_blank"
                            ...
                            style="width:36px; height:36px; display:inline-flex; align-items:center; justify-content:center;"><i
                    ...
                    <?php if (!empty($settings['tripadvisor_url'])): ?>
                        <a href="<?php echo $settings['tripadvisor_url']; ?>" target="_blank"
                            class="btn btn-outline-light btn-sm rounded-circle"
                            style="width:36px; height:36px; display:inline-flex; align-items:center; justify-content:center;"><i
                                class="fa-solid fa-shield-cat"></i></a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
                ...
                <p class="text-white-50 mb-2 small"><i
                        class="fa-solid fa-location-dot text-primary me-2"></i><?php echo htmlspecialchars($settings['hotel_address'] ?? '105A, Court Road, Advocate Gnaniah Complex, Veppamoodu Junction, Nagercoil, Tamil Nadu 629001, India'); ?>
                </p>
                <p class="text-white-50 mb-2 small"><i class="fa-solid fa-phone text-primary me-2"></i><a
                        href="tel:<?php echo preg_replace('/[^0-9+]/', '', $settings['hotel_phone'] ?? '+919994999695'); ?>"
...
<a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', $settings['hotel_phone'] ?? '919994999695'); ?>"
    target="_blank" class="whatsapp-float" title="Chat with Concierge on WhatsApp">
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: var(--radius-md); overflow: hidden;">
            <div class="modal-header bg-dark text-white p-4">
                <div>
                    ...
                    <h4 class="modal-title font-serif mb-0 text-white" id="quickBookingModalLabel">Book Your Luxury Stay
                    </h4>
                </div>
            ...
            <div class="modal-body p-4 p-md-5">
                <form id="bookingForm" action="<?php echo base_url('book-room'); ?>" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="search-field-label"><i class="fa-solid fa-calendar text-primary"></i> Check-In
                                Date *</label>
                            <input type="date" name="check_in" id="modal_check_in" class="search-field-input" required
                                min="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="search-field-label"><i class="fa-solid fa-calendar text-primary"></i>
                                Check-Out Date *</label>
                            <input type="date" name="check_out" id="modal_check_out" class="search-field-input" required
                                min="<?php echo date('Y-m-d', strtotime('+1 day')); ?>"
                                value="<?php echo date('Y-m-d', strtotime('+1 day')); ?>">
                        </div>

                        <div class="col-md-6">
                            <label class="search-field-label"><i class="fa-solid fa-bed text-primary"></i> Preferred
                                Room / Suite</label>
                            <select name="selected_room_title" id="modal_room_select" class="search-field-input">
                                ...
                                <?php if (!empty($featured_rooms)):
                                    foreach ($featured_rooms as $rm): ?>
                                        <option value="<?php echo $rm['id']; ?>"><?php echo htmlspecialchars($rm['title']); ?>
                                            (₹<?php echo number_format($rm['price'], ($rm['price'] == floor($rm['price']) ? 0 : 2)); ?>/night)
                                        </option>
                        ...
                        <div class="col-md-3">
                            <label class="search-field-label"><i class="fa-solid fa-child text-primary"></i>
                                Children</label>
                        ...
                        <div class="col-md-6">
                            <label class="search-field-label"><i class="fa-solid fa-user text-primary"></i> Full Name
                                *</label>
                            <input type="text" name="guest_name" class="search-field-input" placeholder="e.g. John Doe"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label class="search-field-label"><i class="fa-solid fa-envelope text-primary"></i> Email
                                Address *</label>
                            <input type="email" name="email" class="search-field-input"
                                placeholder="e.g. john@example.com" required>
                        </div>
                        <div class="col-md-6">
                            <label class="search-field-label"><i class="fa-solid fa-phone text-primary"></i> Phone
                                Number *</label>
                            <input type="tel" name="phone" class="search-field-input" placeholder="e.g. +91 98765 43210"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label class="search-field-label"><i class="fa-solid fa-comment-dots text-primary"></i>
                                Special Requests</label>
                            <input type="text" name="special_requests" class="search-field-input"
                                placeholder="Airport pickup, floral arrangement, etc.">
                        </div>
                    </div>
